  ...
  return ( 
        <article className="stats-card">
            ...
            <div className="content">
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        <figure className="flex items-center gap-1">
                            <img src={`/assets/icons/${isDecrement ? 'arrow-down-red.svg' :
                ...
                <img src={`/assets/icons/${isDecrement ? 'decrement.svg' : 'increment.svg' }`} alt="trend graph" 
                            className="xl:w-32 w-full h-full md:w-32 xl:h-full"
                        />
            </div>
        </article>
  )
